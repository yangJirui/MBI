...
def reconstruction(seed, mask, method='dilation', selem=None, offset=None):
    ...
    # add by yjr
    shape_after_padding = images.shape[1:]
    images[0, 0+padding[0]:images.shape[1]-padding[0], 0+padding[1]:images.shape[2]-padding[1]] = seed
    images[1, 0+padding[0]:images.shape[1]-padding[0], 0+padding[1]:images.shape[2]-padding[1]] = mask
    ...
    return rec_img[0+padding[0]:shape_after_padding[0]-padding[0], 0+padding[1]:shape_after_padding[1]-padding[1]]